...
abstract class ZohoSalesIQMobilistenSpec internal constructor(context: ReactApplicationContext) :
    ...
    abstract fun registerVisitorNew(uniqueId: String?, visitorInfo: ReadableMap?, callback: Callback?)
    abstract fun unregisterVisitor(callback: Callback?)
    abstract fun unregisterVisitorNew(registerAsGuest: Boolean, callback: Callback?)
