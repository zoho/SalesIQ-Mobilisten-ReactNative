...
abstract class ZohoSalesIQMobilistenSpec internal constructor(context: ReactApplicationContext) :
  ...
  abstract fun fetchAttenderImage(attenderId: String, defaultImage: Boolean, imageCallback: Callback)
  ...
  abstract fun startNewChat(question: String, customChatId: String?, departmentName: String?, callback: Callback)
  abstract fun startNewChatWithTrigger(customChatId: String?, departmentName: String?, callback: Callback)
